...
app.set('port', process.env.PORT || process.env.OPENSHIFT_NODEJS_PORT || 8282);
...
app.get('/results', resultsController.getResults);
app.get('/rating', ratingController.getRating);
